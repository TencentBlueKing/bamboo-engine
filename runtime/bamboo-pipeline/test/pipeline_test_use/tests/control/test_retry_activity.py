...
class TestRetryActivity(EngineTestCase):
    def test_retry_with_simple_pipeline(self):
        ...
        self.retry_activity(act_1, {"bit": 1})
    ...
    def test_retry_with_subprocess_has_parallel(self):
        parallel_count = 5
        start = EmptyStartEvent()
        ...
        for node in fail_nodes:
            self.retry_activity(node, {"bit": 1})
