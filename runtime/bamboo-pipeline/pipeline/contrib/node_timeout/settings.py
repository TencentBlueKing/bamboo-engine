...
class NodeTimeoutSettngs:
    PREFIX = "PIPELINE_NODE_TIMEOUT"
    DEFAULT_SETTINGS = {
        "handler": node_timeout_handler,
        "dispatch_queue": None,
        "handle_queue": None,
        "executing_pool": "executing_node_pool",
    }
...
node_timeout_settings = NodeTimeoutSettngs()
