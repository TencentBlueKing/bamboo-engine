...
from pipeline.eri.doctor import RunningProcessFinishedStateDoctor


class RunningProcessFinishedStateDoctorTestCase(TestCase):
    def setUp(self) -> None:
        self.doctor = RunningProcessFinishedStateDoctor(
    ...
    def test_advice__current_node_is_parallel_gateway(self):
        ...
        with patch("pipeline.eri.doctor.BambooDjangoRuntime", MockBambooDjangoRuntime):
            self.assertEqual(self.doctor.advice(), "child process is ok, make process asleep")
