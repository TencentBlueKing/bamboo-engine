...
from pipeline.eri.doctor import SuspendedProcessReadyStateDoctor


class SuspendedProcessReadyStateDoctorTestCase(TestCase):
    def setUp(self) -> None:
        self.doctor = SuspendedProcessReadyStateDoctor(
