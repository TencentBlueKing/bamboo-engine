...
from pipeline.eri.doctor import RunningProcessFailedStateDoctor


class RunningProcessFailedStateDoctorTestCase(TestCase):
    def setUp(self) -> None:
        self.doctor = RunningProcessFailedStateDoctor(
