...
from pipeline.eri.doctor import AsleepProcessReadyStateDoctor


class AsleepProcessReadyStateDoctorTestCase(TestCase):
    def setUp(self) -> None:
        self.doctor = AsleepProcessReadyStateDoctor(
