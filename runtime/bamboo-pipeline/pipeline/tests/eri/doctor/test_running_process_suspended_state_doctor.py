...
from pipeline.eri.doctor import RunningProcessSuspendedStateDoctor


class RunningProcessSuspendedStateDoctorTestCase(TestCase):
    def setUp(self) -> None:
        self.doctor = RunningProcessSuspendedStateDoctor(
