...
from pipeline.eri.doctor import RunningProcessReadyStateDoctor


class RunningProcessReadyStateDoctorTestCase(TestCase):
    def setUp(self) -> None:
        self.doctor = RunningProcessReadyStateDoctor(
