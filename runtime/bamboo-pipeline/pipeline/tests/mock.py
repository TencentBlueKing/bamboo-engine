...
class StartEventObject(IdentifyObject):
    def __init__(self, id=None, node=None, data=None):
...
class MockQuerySet(object):
    def __init__(self, exists_return=True, get_return=None, first_return=None, qs=None, update_return=1):
        self.update = mock.MagicMock(return_value=update_return)
