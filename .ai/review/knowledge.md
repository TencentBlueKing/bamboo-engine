...
这是当前 LTS 的源码索引和契约，不是缺陷清单。2026-09-09 刷新远程基线：`3ed8129532b6a23a51de4744b02adafadfc36148`。AI CI 从已合入 master 的 `30438665e61945b90bf4c6789db94e7cf42f31d4` 接入，业务源码事实以本分支为准；以后审查需再次读取实际 PR base/head。
